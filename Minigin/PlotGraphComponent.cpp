...
namespace dae
{
	PlotGraphComponent::PlotGraphComponent(GameObject& pOwner)
		: BaseComponent(pOwner)
	{
		m_TrashCache = std::make_unique<TrashCache>();
	}

	PlotGraphComponent::~PlotGraphComponent()
	{

	}

	void PlotGraphComponent::Render()
	{
		Exercise1();
		Exercise2();
	}

	void PlotGraphComponent::Update()
	{

	}

	void PlotGraphComponent::Exercise1()
	{
	...
	void PlotGraphComponent::Exercise2()
	{
	...
	void PlotGraphComponent::PlotGraph(std::vector<float>& ydata)
	{
	...
	void PlotGraphComponent::PlotGraphs(std::vector<std::vector<float>>& ydata)
	{
