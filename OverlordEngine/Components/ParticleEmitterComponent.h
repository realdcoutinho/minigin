...
struct ParticleEmitterSettings
{
	...
	bool isRotateUV{ true };
	bool isFacingCamera{ true };
	bool isRotating{ false };
	float rotationSpeed{ 0.0f };

	XMFLOAT3 rotationAxis{ 0.0f, 0.0f, 0.0f };
	float rotationDisplacement{ 0.0f };
...
{
public:
	ParticleEmitterComponent(const std::wstring& assetFile, const ParticleEmitterSettings& emitterSettings = {}, UINT particleCount = 50, XMFLOAT3 location = {});
