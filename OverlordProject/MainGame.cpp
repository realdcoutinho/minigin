...
#include "Scenes/Mario/MarioBomb.h"
...
#ifdef MarioGame
#include "Scenes/MarioScene/MainMenuScene.h"
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	gameContext.windowTitle = L"GP2 - Mario Bomb-Omb (2023) | (2DAE13) Diogo de Moura Coutinho";
...
void MainGame::Initialize()
{
	...
	//SceneManager::Get()->AddGameScene(new MarioBomb());
	...
	SceneManager::Get()->AddGameScene(new MarioBombScene());
#endif
