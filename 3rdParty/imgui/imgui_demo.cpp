...
void ImGui::ShowPlotGraph(bool* p_open)
{
    bool test = true;
    p_open = &test;
...
//    }
    ...
    if (ImGui::TreeNode("Plotting"))
    {
        ...
        //    //    av += averages[n];
        //    //av /= (float)averages.size();
        //    char overlay[32];
        //    //sprintf(overlay, "avg %f", av);
        //    ImGui::PlotLines("Lines", takes, IM_ARRAYSIZE(takes), 0, overlay, -1.0f, 1.0f, ImVec2(0, 80.0f));
        //}
...
void ImGui::Test(bool* p_open)
{
    p_open;

    ////static float steps[] = { 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024 };
    //float microseconds[] = { 5064, 4733, 3640, 3369, 3665, 2590, 1331, 1166, 502, 191, 136 };
    ...
    //    x_data[i] = t;
    //    const float arg = 2 * 3.1f * freq * t;
    //    y_data1[i] = sin(arg);
    //    y_data2[i] = y_data1[i] * -0.6f + sin(2 * arg) * 0.4f;
    //    y_data3[i] = y_data2[i] * -0.6f + sin(3 * arg) * 0.4f;
    //}

    //static const float* y_data[] = { microseconds/*, microseconds, microseconds*/ };
    ...
    //for (size_t i{}; i < 11; ++i)
    //{
    //    y_data[i] = microseconds[i];
    //}

    float y_data[] = { 5064, 4733, 3640, 3369, 3665, 2590, 1331, 1166, 502, 191, 136 };
    float x_data[] = { 1.f, 2.f, 4.f, 8.f, 16.f, 32.f, 64.f, 128.f, 256.f, 512.f, 1024.f };
